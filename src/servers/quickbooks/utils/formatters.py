def format_customer(customer):
    ...
    return {
        ...
        "email": getattr(customer.PrimaryEmailAddr, "Address", "") if hasattr(customer, "PrimaryEmailAddr") else "",
        "phone": getattr(customer.PrimaryPhone, "FreeFormNumber", "") if hasattr(customer, "PrimaryPhone") else "",
...
def format_invoice(invoice):
    ...
    return {
        ...
        "customer": getattr(invoice.CustomerRef, "name", "") if hasattr(invoice, "CustomerRef") else "",
