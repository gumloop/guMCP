...
def create_server(user_id: str, api_key: Optional[str] = None) -> Server:
        ...
        return [
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "q_keywords": {"type": "string", "description": "Search keywords to match across contact fields"},
                        "contact_stage_ids": {"type": "array", "items": {"type": "string"}, "description": "The Apollo IDs for the contact stages to filter by"},
                        "account_id": {"type": "string", "description": "Filter by specific account ID"},
                        "organization_name": {"type": "string", "description": "Filter by company/organization name"},
                        ...
                        "sort_by_field": {"type": "string", "description": "Field to sort by (e.g., contact_created_at, contact_updated_at)"},
                        "sort_ascending": {"type": "boolean", "description": "Sort in ascending order if true, descending if false"},
                        "page": {"type": "integer", "description": "The page number of results to retrieve"},
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "q_organization_name": {"type": "string", "description": "Add keywords to narrow the search of the accounts in your team's Apollo account"},
                        "account_stage_ids": {"type": "array", "items": {"type": "string"}, "description": "The Apollo IDs for the account stages that you want to include in your search results"},
                        "sort_by_field": {"type": "string", "description": "Sort the matching accounts by one of: account_last_activity_date, account_created_at, account_updated_at"},
                        "sort_ascending": {"type": "boolean", "description": "Set to true to sort the matching contacts in ascending order. Defaults to false."},
                        "page": {"type": "integer", "description": "The page number of the Apollo data that you want to retrieve"},
                        "per_page": {"type": "integer", "description": "The number of search results that should be returned for each page"}
                    }
                }
            ),
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "hashed_email": {"type": "string", "description": "The hashed email of the person (MD5 or SHA-256)"},
                        "organization_name": {"type": "string", "description": "The name of the person's employer"},
                        "domain": {"type": "string", "description": "The domain name for the person's employer"},
                        "id": {"type": "string", "description": "The Apollo ID for the person"},
                        "linkedin_url": {"type": "string", "description": "The URL for the person's LinkedIn profile"},
                        "reveal_personal_emails": {"type": "boolean", "description": "Set to true to reveal personal emails"},
                        "reveal_phone_number": {"type": "boolean", "description": "Set to true to reveal phone numbers"},
                        "webhook_url": {"type": "string", "description": "Webhook URL for phone number verification"}
                    }
                }
            ),
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "domain": {"type": "string", "description": "The domain of the company to enrich (e.g., apollo.io, microsoft.com)"}
                    },
                    "required": ["domain"]
                }
            ),
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "first_name": {"type": "string", "description": "The first name of the contact you want to create"},
                        "last_name": {"type": "string", "description": "The last name of the contact you want to create"},
                        "organization_name": {"type": "string", "description": "The name of the contact's employer (company)"},
                        "title": {"type": "string", "description": "The current job title that the contact holds"},
                        "account_id": {"type": "string", "description": "The Apollo ID for the account to which you want to assign the contact"},
                        "email": {"type": "string", "description": "The email address of the contact"},
                        "website_url": {"type": "string", "description": "The corporate website URL for the contact's current employer"},
                        "label_names": {"type": "array", "items": {"type": "string"}, "description": "Add the contact to lists within your team's Apollo account"},
                        "contact_stage_id": {"type": "string", "description": "The Apollo ID for the contact stage to which you want to assign the contact"},
                        "present_raw_address": {"type": "string", "description": "The personal location for the contact"},
                        "direct_phone": {"type": "string", "description": "The primary phone number for the contact"},
                        "corporate_phone": {"type": "string", "description": "The work/office phone number for the contact"},
                        "mobile_phone": {"type": "string", "description": "The mobile phone number for the contact"},
                        "home_phone": {"type": "string", "description": "The home phone number for the contact"},
                        "other_phone": {"type": "string", "description": "An unknown type of phone number or an alternative phone number for the contact"}
                    },
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "contact_id": {"type": "string", "description": "The Apollo ID for the contact that you want to update"},
                        "first_name": {"type": "string", "description": "Update the contact's first name"},
                        "last_name": {"type": "string", "description": "Update the contact's last name"},
                        "organization_name": {"type": "string", "description": "Update the name of the contact's employer"},
                        "title": {"type": "string", "description": "Update the contact's job title"},
                        "account_id": {"type": "string", "description": "Update the Apollo ID for the account associated with the contact"},
                        "email": {"type": "string", "description": "Update the contact's email address"},
                        "website_url": {"type": "string", "description": "Update the corporate website URL for the contact's employer"},
                        "label_names": {"type": "array", "items": {"type": "string"}, "description": "Update the lists the contact belongs to"},
                        "contact_stage_id": {"type": "string", "description": "Update the contact stage for the contact"},
                        "present_raw_address": {"type": "string", "description": "Update the contact's personal location"},
                        "direct_phone": {"type": "string", "description": "Update the contact's primary phone number"},
                        "corporate_phone": {"type": "string", "description": "Update the contact's work phone number"},
                        "mobile_phone": {"type": "string", "description": "Update the contact's mobile phone number"},
                        "home_phone": {"type": "string", "description": "Update the contact's home phone number"},
                        "other_phone": {"type": "string", "description": "Update an alternative phone number for the contact"}
                    },
                    "required": ["contact_id"]
                }
            ),
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "contact_id": {"type": "string", "description": "The Apollo ID for the contact that you want to delete"}
                    },
                    "required": ["contact_id"]
                }
            ),
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "Name of the account you are creating (human-readable)"},
                        "domain": {"type": "string", "description": "The domain name for the account (e.g., apollo.io)"},
                        "owner_id": {"type": "string", "description": "The ID for the account owner within your team's Apollo account"},
                        "account_stage_id": {"type": "string", "description": "The Apollo ID for the account stage to assign the account to"},
                        "phone": {"type": "string", "description": "The primary phone number for the account"},
                        "raw_address": {"type": "string", "description": "The corporate location for the account"}
                    },
                    "required": ["name"]
                }
            ),
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "account_id": {"type": "string", "description": "The Apollo ID for the account that you want to update"},
                        "name": {"type": "string", "description": "Update the account's name"},
                        "domain": {"type": "string", "description": "Update the domain name for the account (e.g., apollo.io)"},
                        "owner_id": {"type": "string", "description": "The ID for the account owner within your team's Apollo account"},
                        "account_stage_id": {"type": "string", "description": "The Apollo ID for the account stage to assign the account to"},
                        "raw_address": {"type": "string", "description": "Update the corporate location for the account"},
                        "phone": {"type": "string", "description": "Update the primary phone number for the account"}
                    },
                    "required": ["account_id"]
                }
            ),
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "name": {"type": "string", "description": "Name of the deal you are creating (human-readable)"},
                        "owner_id": {"type": "string", "description": "The ID for the deal owner within your team's Apollo account"},
                        "account_id": {"type": "string", "description": "The ID for the account within your Apollo instance"},
                        "amount": {"type": "string", "description": "The monetary value of the deal (no commas or currency symbols)"},
                        "opportunity_stage_id": {"type": "string", "description": "The ID for the deal stage within your team's Apollo account"},
                        "closed_date": {"type": "string", "description": "The estimated close date for the deal, formatted as YYYY-MM-DD"}
                    },
                    "required": ["name"]
                }
            ),
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "opportunity_id": {"type": "string", "description": "The ID for the deal you want to update"},
                        "name": {"type": "string", "description": "Update the name of the deal"},
                        "owner_id": {"type": "string", "description": "The ID for the deal owner within your team's Apollo account"},
                        "account_id": {"type": "string", "description": "The ID for the account within your Apollo instance"},
                        "amount": {"type": "string", "description": "The monetary value of the deal (no commas or currency symbols)"},
                        "opportunity_stage_id": {"type": "string", "description": "The ID for the deal stage within your team's Apollo account"},
                        "closed_date": {"type": "string", "description": "The estimated close date for the deal, formatted as YYYY-MM-DD"},
                        "is_closed": {"type": "boolean", "description": "Set to true to update the status of the deal to closed"},
                        "is_won": {"type": "boolean", "description": "Set to true to update the status of the deal to won"},
                        "source": {"type": "string", "description": "Update the source of the deal"}
                    },
            ...
            types.Tool(
                ...
                inputSchema={
                    "type": "object",
                    "properties": {
                        "user_id": {"type": "string", "description": "The ID for the task owner within your team's Apollo account"},
                        "contact_ids": {"type": "array", "items": {"type": "string"}, "description": "The Apollo IDs for the contacts that will receive the action"},
                        "priority": {"type": "string", "description": "Priority level: high, medium, or low"},
                        "due_at": {"type": "string", "description": "The due date and time in ISO 8601 format (e.g., 2025-02-15T08:10:30Z)"},
                        "type": {"type": "string", "description": "Task type: call, outreach_manual_email, linkedin_step_connect, linkedin_step_message, linkedin_step_view_profile, linkedin_step_interact_post, action_item"},
                        "status": {"type": "string", "description": "Status: scheduled, completed, or archived"},
                        "note": {"type": "string", "description": "Description for the task (human-readable message)"}
                    },
                    "required": ["user_id", "contact_ids", "priority", "due_at", "type", "status"]
                }
            ),
            types.Tool(
                name="list_users",
    ...
    async def handle_call_tool(
        ...
        if not api_key:
            ...
            return [TextContent(type="text", text="Apollo API key not found. Please set your API key.")]
            ...
            match name:
                case "enrich_person":
                    ...
                    if "reveal_personal_emails" in arguments:
                        data["reveal_personal_emails"] = arguments["reveal_personal_emails"]
                ...
                case "create_contact":
                    ...
                    for param in [
                        ...
                        "account_id", "email", "website_url", "contact_stage_id",
                        "present_raw_address", "direct_phone", "corporate_phone",
                ...
                case "create_account":
                    ...
                    # Add parameters if provided
                    for param in ["name", "domain", "owner_id", "account_stage_id", "phone", "raw_address"]:
                        if param in arguments:
                            data[param] = arguments[param]
                ...
                case "update_account":
                    ...
                    # Add parameters if provided
                    for param in ["name", "domain", "owner_id", "account_stage_id", "raw_address", "phone"]:
                        if param in arguments:
                            data[param] = arguments[param]
                ...
                case "create_deal":
                    ...
                    # Add parameters if provided
                    for param in ["name", "owner_id", "account_id", "amount", "opportunity_stage_id", "closed_date"]:
                        if param in arguments:
                            data[param] = arguments[param]
                ...
                case "update_deal":
                    ...
                    # Add parameters if provided
                    for param in [
                        "name", "owner_id", "account_id", "amount", "opportunity_stage_id",
                        "closed_date", "is_closed", "is_won", "source"
                    ]:
                        if param in arguments:
                            data[param] = arguments[param]
                ...
                case "organization_search":
                    ...
                    for param in [
                        ...
                        "organization_not_locations", "currently_using_any_of_technology_uids",
                        "q_organization_keyword_tags", "organization_ids"
                    ]:
                        if param in arguments:
                ...
                case "people_search":
                    ...
                    # Add scalar parameters if provided
                    for param in ["q_keywords", "include_similar_titles", "page", "per_page"]:
                        if param in arguments:
                            data[param] = arguments[param]
                ...
                case "search_contacts":
                    ...
                    # Add search parameters if provided
                    for param in [
                        "q_keywords", "account_id", "organization_name",
                ...
                case "create_task":
                    ...
                    required_params = ["user_id", "contact_ids", "priority", "due_at", "type", "status"]
                    ...
                    if isinstance(contact_ids, list):
                        ...
                        error_message = "Error: contact_ids must be an array of string IDs"
                        logger.error(error_message)
                        return [TextContent(type="text", text=error_message)]
